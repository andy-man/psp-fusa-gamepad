 ...
 */
#define USB_BCD_200	0x0200
#define USB_BCD_110	0x0110
#define USB_BCD_100	0x0100
/*
 * Device and/or Interface Class codes
 */
...
struct HidDescriptor
{
  ...
  // WINGMAN uses only one Report descriptor :)
  struct DescriptorList {
	  unsigned char  bReportType;
	  unsigned short wReportLength;
  } descriptorlist[1];
